...
def print_second_metric(path, gt_file, classes):
    parser2 = argparse.ArgumentParser()

    parser2.add_argument('-pkl_path', type=str, default=path)  # './test.pkl'
    # parser.add_argument('')
    args2 = parser2.parse_args()

    pkl_path = args2.pkl_path
...
if __name__ == '__main__':
    ...
    parser.add_argument('-pkl_path', type=str, default='/home/amax/HHD1/mzh/TSST/Charades/ASLossNo_rank_I3D_gs/11-tensor(26.6675)-tensor(27.0469).pkl')  # './test.pkl'
    # parser.add_argument('')
    ...
    # gt_file = '/media/faegheh/DATA1/Datasets/Charades-Dataset/charades.json'
    classes = 157
